...
emoji_list.children[0].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':kitty:';          textbar.value = textbox})
emoji_list.children[1].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':cock:';           textbar.value = textbox })
emoji_list.children[2].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':sadcat:';         textbar.value = textbox})
emoji_list.children[3].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':doggodance:';     textbar.value = textbox})
emoji_list.children[4].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':shakyshaky:';     textbar.value = textbox})
emoji_list.children[5].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':ban:';            textbar.value = textbox})
emoji_list.children[6].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':joyabel:';        textbar.value = textbox})
emoji_list.children[7].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':dazelaugh:';      textbar.value = textbox})
emoji_list.children[8].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':madblob:';        textbar.value = textbox})
emoji_list.children[9].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':flame:';          textbar.value = textbox})
emoji_list.children[10].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':gg:';            textbar.value = textbox})
emoji_list.children[11].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':clappincheeks:'; textbar.value = textbox})
emoji_list.children[12].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':dababy:';        textbar.value = textbox})
emoji_list.children[13].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':peaceout:';      textbar.value = textbox})
emoji_list.children[14].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':wut:';           textbar.value = textbox})
emoji_list.children[15].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':ez:';            textbar.value = textbox})
emoji_list.children[16].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':twerk:';         textbar.value = textbox})
emoji_list.children[17].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':stare:';         textbar.value = textbox})
emoji_list.children[18].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':hakcan:';        textbar.value = textbox})
emoji_list.children[19].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':thonk:';         textbar.value = textbox})
emoji_list.children[20].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':awana:';         textbar.value = textbox})
emoji_list.children[21].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':clapp:';         textbar.value = textbox})
emoji_list.children[22].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':amongus:';       textbar.value = textbox})
emoji_list.children[23].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':vibing:';        textbar.value = textbox})
emoji_list.children[24].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':eri:';           textbar.value = textbox})
emoji_list.children[25].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':sheeesh:';       textbar.value = textbox})
emoji_list.children[26].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':mcdonalds:';     textbar.value = textbox})
emoji_list.children[27].addEventListener('click', function(){var textbox = textbar.value; textbox = textbox + ':caught4k:';      textbar.value = textbox})
